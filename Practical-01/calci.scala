class Arithmetic()
{
	...
	def calculate(a : Int , b : Int) // method for performing operation
	{
...
object calci
{
	def main( args: Array[String])
	{
		...
		obj1.calculate(6,2)     // function call with help of object
		obj1.result()		


                	obj2.calculate(53,5)     // function call with help of object
		obj2.result()
		
		obj3.calculate(11,16)     // function call with help of object
		obj3.result()
	}
}